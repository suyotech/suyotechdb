...
// Define type aliases for the supported constructor types
...
class Schema {
    private schema: SchemaTypeDefinition;
    ...
    private validateType(value: any, type: ConstructorType): boolean {
        switch (type) {
            case String:
    ...
    private getTypeName(type: ConstructorType): string {
        // Convert constructor function name to lowercase type name
...
class Model {
     ...
     */
    #matchesQuery(entry: any, query: any): boolean {
...
class Operate {
     ...
     */
    sort(sortObj: { [key: string]: number }): Operate {
     ...
     */
    select(selectObj: { [key: string]: number }): Operate {
